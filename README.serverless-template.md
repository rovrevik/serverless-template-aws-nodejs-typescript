...
Use this template to create a new Serverless project with the following command:
```bash
serverless create \
 --template-url=https://github.com/rovrevik/serverless-template-aws-nodejs-typescript \
...
### Typescript
- Install [Typescript](http://www.typescriptlang.org/index.html) in the project `npm install --save-dev typescript`
...
### Serverless
- Install serverless into the project. `npm install --save-dev serverless`
...
### Testing
- Install [Jest](https://jestjs.io). `npm install --save-dev jest`
- Install @types/jest. `npm install --save-dev @types/jest`
- Install [ts-jest](https://kulshekhar.github.io/ts-jest/). `npm install --save-dev ts-jest`
...
- Install [Bunyan](https://www.npmjs.com/package/bunyan). `npm install --save-dev @types/bunyan`
